...
public View newView(Context context, Cursor cursor, ViewGroup parent) {
    ...
    public void bindView(final View view, final Context context, final Cursor cursor) {
        ...
        int productQuantityColumnIndex = cursor.getColumnIndex(Inventory.InventoryEntry.COLUMN_PRODUCT_QUANTITY);
        ...
        productPriceTextView.setText(context.getString(R.string.product_price) + " : " + productPrice + "  " + context.getString(R.string.product_currency));
        ...
        productEditButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri currentProdcuttUri = ContentUris.withAppendedId(Inventory.InventoryEntry.CONTENT_URI, Long.parseLong(productID));
